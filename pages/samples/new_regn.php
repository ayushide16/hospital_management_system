    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="../../assets/images/hopkins.png" alt="logo" /></a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="opd_landing.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="ipd_landing.html"> 
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pharmacy_landing.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="diagnostics_landing.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="payroll_landing.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="accounts_landing.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="settings_landing.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="user_management_landing.html">
              <span class="menu-icon">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item dropdown d-none d-lg-block">
                    <a class="nav-link btn btn-success create-new-button" href="new_regn.php">New Registration</a>
                </li>

               

              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" href="#">Admin Dashboard</a>
              </li>
              ...
              <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Patient Registration Form</li>
                  </ol>
                </nav>
              </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="form-sample" action="blank-page-1.php" method="post" >
                          <br>
                          <p class="card-description"> Patient Identification </p>
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Registration ID</label>
                                <div class="col-sm-9">
                                  <input type="text" name="regn_id" class="form-control" />
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input class="form-control" name="age" placeholder="in years" />
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" name="c_postcode"/>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <button class="btn btn-dark"><a href="../../pages/samples/new_regn.html" style="text-decoration: none; color: white;">Cancel</a></button>
                        </form>
                      </div>
                    </div>
                  </div>
